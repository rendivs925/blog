---
title: "The Vortex Engine: Unifying Propulsion and Zero-Point Energy Extraction Through Rotating Field Coupling to the Superfluid Vacuum"
slug: "the_vortex_engine_unified_propulsion_and_energy"
category: "deep tech"
date: "June 2026"
...
**Atomic Scale:** Electron orbitals with angular momentum (p, d, f orbitals) are vortex probability distributions. The magnetic moment of an atom is a vortex in the vacuum's vector potential. Chemical bonds form when the electron vortices of adjacent atoms couple — they phase-lock and create a shared vortex structure.

**Molecular Scale:** DNA is a double helix — two interlocking vortices. The genetic code is not written in a linear sequence of letters but in the three-dimensional topology of a folded vortex pair. The replication of DNA is the replication of a vortex topology. The very fabric of life is woven from vortices.

**Thermodynamic Scale:** Hurricanes, cyclones, typhoons, tornadoes — these are atmospheric vortices driven by pressure gradients and planetary rotation. The Coriolis effect imparts a preferred rotation direction (counterclockwise in the northern hemisphere, clockwise in the southern). A tornado can lift a house because its core pressure is 10% or more below the ambient atmosphere. The pressure differential is not a side effect — it is the entire mechanism. The tornado does not push. It creates a void, and the heavy atmosphere does the work.
...
**Celestial Scale:** Every planet orbits its star in a vortex. The solar system does not "move through" the galaxy — it spirals through it in a vortex, following the galaxy's spiral density wave. The galaxy itself rotates, creating a spiral vortex of stars, gas, and dark matter. The Local Group, galaxy clusters, superclusters, and the cosmic web — all are vortex structures in the cosmic fluid.

**Relativistic Scale:** A rotating black hole (Kerr black hole) is the ultimate cosmic vortex. The ergosphere — the region where spacetime itself is dragged around by the rotation — is a vortex of spacetime. Frame dragging (Lense-Thirring effect) is the vortex motion of the metric. The accretion disk is a vortex of matter falling inward. The jets from active galactic nuclei are vortex tubes extracting rotational energy from the black hole via the Blandford-Znajek process — a vortex harvesting rotational energy from a vortex.
...
Where n is an integer (the winding number), h is Planck's constant, and m is the mass of the helium atom. The vortex cannot have an arbitrary circulation — only integer multiples of the quantum of circulation. This is topological quantization. The vortex is a knot in the quantum field that cannot be untied. Once created, it persists indefinitely because the universe would have to change its topology to destroy it.
...
Every competing method — static fields, pulsating fields, linear flows — ultimately fails because they lack topological protection. A static field is a potential that does no net work. A pulsating field creates waves that spread and dissipate. A vortex creates a persistent structure that the ambient universe continuously feeds.

This paper presents the complete theoretical and engineering framework for a device that creates a macroscopic quantized vortex in the superfluid vacuum using a rotating charged metal disc. This device — the Vortex Engine — simultaneously:

1. Generates directed propulsion (the craft is pushed by the ambient vacuum into the low-pressure vortex core)
2. Harvests continuous zero-point energy (the ambient vacuum flows into the vortex, doing work that can be captured by a stationary coil)
...
The Biefeld-Brown effect, discovered in the 1920s, demonstrated that an asymmetric high-voltage capacitor produces a net thrust toward the smaller electrode. This was initially hailed as "anti-gravity." It is not. Mainstream physics explains it as ion wind — charged particles accelerated by the field collide with neutral air molecules, creating thrust.

However, experiments in hard vacuum (where no air exists for ion wind) have shown a residual force. This suggests there is a genuine vacuum polarization component — the electric field directly couples to the quantum vacuum, creating a small but real pressure differential.

**The problem:** A static field creates no flow. It polarizes the vacuum — aligns virtual dipoles — but creates no gradient. The vacuum responds elastically, like a spring. The energy you put into polarizing it is returned when you discharge. Net work: zero.

Mathematically, the electrostatic pressure is:

P_el = ½ε₀E²

This pressure is always positive — always pushing outward — and uniform. An asymmetric geometry creates a small imbalance, but the force scales with the difference in area between the two electrodes, not with any fundamental coupling to vacuum dynamics.
...
The lift-to-weight ratio of a Biefeld-Brown lifter is about 1:1 at best, and it only works in atmosphere (ion wind). In vacuum, the residual force is millions of times too small for practical lift. The Biefeld-Brown effect is a real phenomenon, but it is a whisper, not a voice.

### 2.2 Pulsating Electric Fields (Dynamical Casimir)

Pulsating fields represent a genuine improvement over static. By switching the field on and off faster than the vacuum's relaxation time, you create shockwaves — the Dynamical Casimir Effect. This effect actually creates real photons from vacuum fluctuations. It is a proven mechanism of energy extraction from the vacuum.
...
For GaN transistors with nanosecond rise times, this threshold is achievable. The field changes faster than the vacuum can respond — a "snap" that tears the vacuum.
...
Where D is the duty cycle — the ratio of pulse width to period. For nanosecond pulses at MHz repetition rates, D ≈ 0.001 to 0.01. The system is idle 99% of the time.
...
The concept of the vacuum as a physical medium rather than an empty void has a long history in physics. Modern quantum field theory has confirmed that the vacuum is the ground state of all quantum fields — a state of minimum energy that is not zero energy. The vacuum has structure, pressure, density, and dynamics.

**Key properties of the superfluid vacuum:**

**1. It is a Bose-Einstein Condensate (BEC).** The vacuum is a condensate of virtual particle pairs — primarily fermion-antifermion pairs that form bosonic bound states. Below a critical temperature (which is effectively infinite in our universe), these pairs condense into a single coherent quantum state. The entire universe is one quantum object.

**2. It is frictionless (zero viscosity).** A superfluid has zero viscosity because the condensate is a single quantum state. There is no mechanism for friction — there are no "parts" to rub against each other. Any motion in the superfluid persists forever unless converted to another form.

**3. It has immense pressure.** The vacuum energy density predicted by QFT is approximately 10¹¹³ J/m³ — a number so large it is meaningless in practical terms. The observed value is about 10⁻⁹ J/m³ (the dark energy density). The discrepancy (the cosmological constant problem) is the largest unsolved problem in physics. Regardless of the absolute value, the vacuum pressure is real and measurable — the Casimir effect proves it.

**4. Its speed of sound is the speed of light.** In any medium, the speed of sound is determined by:

c_sound = √(γP/ρ)

Where γ is the adiabatic index, P is the pressure, and ρ is the density. For the superfluid vacuum, this gives c, the speed of light. Light is not a particle moving through empty space — it is a sound wave in the vacuum medium. This explains why c is a universal constant: it is a property of the medium, not of the light.

**5. It supports quantized vortices.** Because the vacuum is a superfluid, its rotation is quantized. Any rotation must be carried by quantized vortex lines — lines of zero density around which the superfluid circulates.
...
Where r is the distance from the core, n is the winding number, h is Planck's constant, and m is the mass of the condensate constituent (for the vacuum, this would be the mass scale of the virtual pairs, approximately the electron mass).
...
**Step 1: Charge Coupling.** When high voltage is applied to the disc, the electric field polarizes the vacuum near the disc surface. Virtual dipoles align with the field. The vacuum becomes "stiff" in this region — not in the sense of mechanical stiffness but in the sense that its quantum phase is now coupled to the disc's charge state.

**Step 2: Rotational Coupling.** When the charged disc rotates, the electric field rotates with it. But the electric field is not propagating through the vacuum — it is a configuration of the vacuum itself. A rotating electric field is a rotating configuration of the vacuum polarization.

**Step 3: Phase Winding.** The rotating field forces the vacuum's quantum phase to wind around the disc. If the rotation is fast enough, the phase winding becomes topologically non-trivial — the phase wraps around by 2πn, creating a quantized vortex line above the disc.
...
This is extremely low — almost any rotation will nucleate a vortex. The reason is that the vacuum is a **macroscopic** quantum system, and its critical velocity for vortex nucleation is set by the system size, which is the disc radius, not the atomic scale.
...
The ambient vacuum pressure, whatever its absolute value, is the driving force. The vortex does not create energy — it creates a **pressure differential**, and the ambient vacuum flows through that differential, doing work.

**Analogy:** A hydroelectric dam does not create energy. It creates a height differential, and gravity flows through that differential. The Vortex Engine is a "vacuum dam" — it creates a pressure differential in the superfluid vacuum, and the ambient vacuum flows through that differential.
...
The winding phase reaches a non-trivial topology — the phase wraps by exactly 2πn, creating a quantized vortex line. The vortex core is established above the disc. The pressure inside the core drops below ambient.
...
**Phase 3: Continuous Extraction — Propulsion**

The ambient vacuum pressure pushes the craft into the low-pressure vortex core. This is not "lift" in the aerodynamic sense — it is **spacetime buoyancy**. The craft is not pushed by air but by the pressure gradient of the superfluid vacuum. The vortex points upward, so the craft is pushed upward.
...
This force is proportional to R⁴ω² — extremely sensitive to disc size and rotation rate.

**Phase 4: Continuous Extraction — Power**

The ambient vacuum flows into the low-pressure vortex core. This flow is not a flow of air or any material substance — it is a flow of **vacuum energy** via the Ponderomotive force (the same mechanism as the pulsed resonator's Phase B, but continuous rather than pulsed).
...
Where τ is the torque (dominated by bearing friction and aerodynamic drag on the disc, not by field coupling — the vortex is frictionless).
...
Above this rate, the Engine produces surplus power. Below it, it requires external power.

### 4.3 The Vortex as a Perpetual Engine — A Physical Explanation
...
The Second Law of Thermodynamics states that in a **closed system**, entropy cannot decrease. The key phrase is "closed system." The Vortex Engine is not a closed system — it is an open system coupled to the superfluid vacuum, which is the largest open system in existence.
...
The Vortex Engine receives energy from the vacuum. The vacuum will not die — it is the ground state. It is, for all practical purposes, infinite.

**But does this violate conservation of energy?** No. The energy extracted from the vacuum by the Vortex Engine is balanced by a decrease in the vacuum's energy in the local region. But the vacuum's energy is constantly replenished by the surrounding vacuum — vacuum is not a static thing but a dynamic, flowing medium. The vortex creates a conduit for energy to flow from the surrounding vacuum into the engine.

The electron in your copper wire has been vibrating at 1,570,000 m/s for billions of years without slowing down. It does not violate thermodynamics because it is not a closed system — it is continuously refreshed by the zero-point field. The Vortex Engine is the technological equivalent.
...
This section provides a quantitative comparison of the three methods — static field, pulsating field, and vortex — across all relevant metrics.
...
**Topological protection:** This is the decisive advantage. Static and pulsating fields are topologically trivial — they can decay without resistance. A vortex is a knot in the quantum field that cannot be untied.
...
**Spatial distribution:** A spherical wave radiates its energy over a sphere of area 4πr². A vortex line concentrates its energy along a line. The energy density of the vortex decays as 1/r (because the energy is spread over a cylindrical surface of area 2πrL), not 1/r². This means the vortex can couple efficiently to a harvest coil at practical distances.

**Stability:** A spinning disc is a gyroscope. It resists changes to its orientation. The vortex above it is also a gyroscope — it has angular momentum and resists disturbances. The combination of two coupled gyroscopes (disc + vortex) creates a system that is inherently stable. No active control is needed.
...
(No net energy extraction — the field is static and does no work over a complete cycle.)
...
**Shape:** Shallow dome on top, flat on bottom. The dome shape focuses the vortex above the disc by creating a curved surface that smoothly guides the rotating field lines inward toward the axis. The flat bottom creates a sharp boundary — the field lines from the bottom are perpendicular to the surface, creating a distinct pressure interface.
...
**Material:** 6061 aluminum — highly conductive, lightweight, corrosion-resistant, and available at any metal supplier. For advanced prototypes, copper-clad stainless steel provides better conductivity with structural rigidity.
...
**Surface finish:** Mirror-polished to 0.1 μm RMS or better. A smooth surface minimizes corona discharge and maximizes electric field uniformity. Polishing can be done with progressively finer wet sandpaper (400 → 800 → 1200 → 2000 grit), followed by a buffing wheel with aluminum polish.

**Edge treatment:** The disc edge must be rounded with a radius of at least 2 mm (for the 30 cm prototype) to reduce electric field concentration that causes corona discharge. Sharp edges are the enemy of high voltage — they concentrate the field and leak energy.
...
6. Balance dynamically — high-speed rotation requires the disc's center of mass to coincide with its geometric center within 0.1 mm

### 6.2 The Motor

**Type:** Brushless DC (BLDC) outrunner motor. Outrunner motors have the rotating part (the "bell") on the outside, allowing direct mounting of the disc to the motor housing.
...
- Current: < 1 mA (leakage only — the disc, once charged, draws almost no current)
...
- Current-limited HV supply (max 1 mA — enough to charge the disc, safe enough to survive accidental contact)
...
When tuned, the coil's impedance is purely resistive, maximizing power transfer.
...
3. Spin motor to 5,000 RPM, HV off. Record weight. Any change? (Should be zero — centrifugal forces are internal to the system and do not produce net lift.)
4. Motor off, HV on at 30 kV. Record weight. Any change? (Small or zero. This is the static grip effect — a pure electrostatic pressure on the disc.)
...
**Step 4: Critical Test — Persistence**
...
**Key insight:** Lift scales with R⁴. A 10× larger disc produces 10,000× more lift (at the same voltage and RPM). This is because both the area (R²) and the tangential velocity squared (R²) contribute to the scaling.
...
| Parameter | Prototype | Intermediate | Full Scale |
|-----------|-----------|--------------|------------|
| Disc radius R | 0.15 m | 0.5 m | 2.5 m |
...
3. **Gyroscopic stabilizer:** The spinning disc has significant angular momentum, providing inherent stability against external disturbances
4. **Inertial decoupler:** The vortex field isolates the craft from the surrounding medium, enabling acceleration without G-forces felt by occupants
...
6. **Sensor:** Changes in the vortex's behavior (frequency, amplitude, stability) reveal information about the external environment — gravitational anomalies, atmospheric conditions, approaching objects
...
This single root captures the entire physics of vortex motion. A vortex is a "swimming" motion. A celestial body does not "fly" through empty space — it *swims* through a fluid medium. The Vortex Engine swims through the same medium.
...
The superfluid vacuum is the "water" upon which creation rests. The "Throne" (*al-'arsh* — العرش) represents the divine governance and the boundary conditions of creation — the topological constraints within which the cosmos operates.

The Vortex Engine creates a vortex in this primordial ocean. It does not violate the constraints set by the Throne — it discovers and operates within them. The Throne being "upon water" means that the foundation of all reality is the superfluid vacuum, and that divine order governs its dynamics.
...
This is a direct description of the superfluid vacuum's structure — a woven fabric of fluctuating field lines, ripples, vortices, and topological defects. The Vortex Engine creates a *hubuk* — a woven pattern in the vacuum. The harvest coil reads that pattern.
...
The Vortex Engine is *sulṭān* — technological authority, the means to pass beyond the heavens. It is the key that unlocks the cage of Earth's gravity and the prison of fossil fuel dependency. And it is given to all of humanity — not to a select elite.
...
The connection is profound: all of creation is in a state of *tasbīh* — rhythmic, vibrational, rotational motion that is simultaneously a physical fact and a spiritual act. The electron spinning around an atom, the planet orbiting its star, the galaxy rotating on its axis — all are engaged in *tasbīh*. Their motion is their worship.

The Vortex Engine aligns human technology with this universal act. It does not create motion — it joins the motion that already exists. It does not generate power — it taps into the power that is the baseline of existence.
...
The horizon is where the earth meets the sky — the boundary of our perception. The vortex is a sign in the horizons: a tornado, a galaxy, a hurricane. The electron is a sign within ourselves: every atom in our body contains spinning charged particles. The same principle — the vortex — governs both the macrocosm and the microcosm.
...
1. **Theoretical Gatekeeper:** The Second Law of Thermodynamics, misapplied to open systems. The Vortex Engine does not violate thermodynamics — it opens a system to an infinite source.

2. **Institutional Gatekeeper:** Incrementalism, the slow march of "peer-reviewed" progress that suppresses radical ideas. The Vortex Engine is radical — it will face institutional hostility.

3. **Legal Gatekeeper:** The Invention Secrecy Act of 1951, with 6,155 active secrecy orders in 2023. A patent on the Vortex Engine would be seized. The solution: do not patent. Publish openly.

4. **Economic Gatekeeper:** The petrodollar system, the global energy debt, the sunk cost of trillions of dollars in fossil fuel infrastructure. The Vortex Engine makes oil worthless.

5. **Psychological Gatekeeper:** The Kardashev Scale, which frames energy abundance as millions of years away. The Vortex Engine makes energy abundance available today.
...
**1. Publish the complete theory openly.** This paper is the beginning. Every equation, every calculation, every design parameter — publish it all. In multiple languages. On multiple platforms. So that even if one repository is suppressed, others remain.
...
**3. Crowdsource the development.** The Vortex Engine is simple enough for a garage workshop but deep enough for a physics lab. Different teams around the world can contribute different optimizations — better disc shapes, better HV circuits, better harvest coil geometries.

**4. Decentralize manufacturing.** Once the design is proven, local workshops can build their own units. No centralized factory, no supply chain to control, no bottleneck to exploit.

**5. Create a certification standard.** As multiple teams build working Vortex Engines, a community standard emerges: minimum safety requirements, performance verification protocols, best practices.
...
**Planetary healing:** The money and resources currently spent on energy extraction and warfare can be redirected to restoring ecosystems, cleaning oceans, reforesting land.

### 9.4 The Tadarruj Strategy

From the Wali Songo methodology: *tadarruj* — gradual approach. Do not demand immediate change. Address behavior before belief. Use art and culture as media for transformation.
...
**Phase 3: Flying demonstration.** A prototype lifting its own weight and the weight of its power source. This changes the conversation entirely — flight without fuel becomes undeniable.
...
The Vortex Engine is not an invention — it is a **discovery** of a principle that has existed since the beginning of creation. The tornado has been demonstrating it for billions of years. The galaxy has been demonstrating it for billions of years. The electron has been demonstrating it for billions of years.
...
The vortex is nature's most efficient mechanism because it is **topologically protected**. A quantized vortex in a superfluid cannot dissipate — it is permanent. Every competing method — static fields, pulsating fields, linear flows — ultimately fails because they lack this protection. The vortex is not just more efficient. It is the only method that operates in harmony with the fundamental structure of the universe.
